...
export class initdb1678412387196 implements MigrationInterface {
  name = 'initdb1678412387196';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "bid" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "bidTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT 'NOW()', "auctionId" uuid, CONSTRAINT "PK_0cdfb69539712b75b07c5fbf19a" PRIMARY KEY ("id", "userId", "bidTime"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "auction" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "expirationTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT 'NOW()', "isEnded" boolean NOT NULL, "productId" uuid, CONSTRAINT "PK_9dc876c629273e71646cf6dfa67" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying NOT NULL, "categoryId" character(36) NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT 'NOW()', "editedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT 'NOW()', "isShippable" boolean NOT NULL, "isAuction" boolean NOT NULL, "price" bigint NOT NULL, "views" smallint NOT NULL, "likes" smallint NOT NULL, "userId" uuid, "currencyId" uuid, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO public.products VALUES ('68485e59-6f6d-458a-ad89-598b71917533', 'Pokemon Zafiro GBA Pal ESP', 'Descripción del producto 1', '0                                   ', '2023-03-09 08:10:29.283261', '2023-03-09 08:10:29.283261', true, true, 20939, 50, 10, 'f23b6bc8-24ed-4a08-8ecd-dc6b0fc5a404', '2763de19-9719-415d-af6e-8157cac9da59');
                  ...
                  INSERT INTO public.products VALUES ('26e90ed4-027c-42dd-9639-a0f324a1a6dc', 'Pokemon Cristal GBC precintado', 'Descripción del producto 3', '0                                   ', '2023-03-09 08:10:29.283261', '2023-03-09 08:10:29.283261', true, true, 12334, 231, 88, 'f23b6bc8-24ed-4a08-8ecd-dc6b0fc5a404', '2763de19-9719-415d-af6e-8157cac9da59');
                  INSERT INTO public.products VALUES ('a0317385-9d67-4304-a0ea-74583c0d97c1', 'Xenoblade Chronicles 3 Switch en perfecto estado', 'Descripción del producto 4', '0                                   ', '2023-03-09 08:10:29.283261', '2023-03-09 08:10:29.283261', true, true, 9343, 872, 123, 'f23b6bc8-24ed-4a08-8ecd-dc6b0fc5a404', '2763de19-9719-415d-af6e-8157cac9da59');
