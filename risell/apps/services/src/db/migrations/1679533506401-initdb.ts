...
export class initdb1679533506401 implements MigrationInterface {
  name = 'initdb1679533506401';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "bid" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "bidTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT 'NOW()', "amount" integer NOT NULL, "auctionId" uuid, CONSTRAINT "PK_0cdfb69539712b75b07c5fbf19a" PRIMARY KEY ("userId", "bidTime"))`,
    );
    await queryRunner.query(
