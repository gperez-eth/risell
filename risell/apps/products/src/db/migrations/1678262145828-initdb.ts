    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        for (let i = 0; i < this.products.length; i++) { 
            ...
            .query(`INSERT INTO products (title, description, "categoryId", "editedAt", "isShippable", "isAuction", price, "currencyId", views, likes)
                ...
                [this.products[i].title, this.products[i].description, this.products[i].categoryId, this.products[i].editedAt, this.products[i].isShippable, this.products[i].isAuction, this.products[i].price, this.products[i].currencyId, this.products[i].views, this.products[i].likes]
            );
        }
